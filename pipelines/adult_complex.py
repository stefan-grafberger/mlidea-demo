...
train_file = os.path.join(str(get_project_root()), "pipelines", "datasets", "adult_complex", "adult_train.csv")
train_data = pd.read_csv(train_file, na_values='?', index_col=0)
test_file = os.path.join(str(get_project_root()), "pipelines", "datasets", "adult_complex", "adult_test.csv")
